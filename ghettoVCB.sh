...
VM_BACKUP_VOLUME="/vmfs/volumes/wd-mycloud_backup/poweredge-esxi.VM-Backups"
...
# Email SMTP server
EMAIL_SERVER=mail.dfc.be

# Email SMTP server port
EMAIL_SERVER_PORT=25

# Email FROM
EMAIL_FROM=oliver.may@dfc.be

# Email RCPT
EMAIL_TO=oliver.may@dfc.be
